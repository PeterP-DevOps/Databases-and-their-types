...
Ответ: Тип СУБД в такой задаче стоит выбирать прежде всего по характеру нагрузки (OLAP‑аналитика vs OLTP‑транзакции) и модели данных.
